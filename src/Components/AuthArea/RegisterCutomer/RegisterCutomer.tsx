...
import "./RegisterCutomer.css";



function RegisterCutomer(): JSX.Element {
    const {register, handleSubmit} = useForm<CustomerModel>();
    const navigate = useNavigate();

    async function send(user: CustomerModel) {
        try{
	...
	<div className="screen-customer">
		<div className="screen__content">
            ...
            <div className="login__field1">
                ...
                <label className="company-name-label">First Name: </label>
                <input  type="text" className="login__input" placeholder="Enter your name" {...register("firstName")} />

				</div>
				<div className="login__field1">
					<i className="login__icon fas fa-user"></i>
                <label className="company-name-label">Last Name: </label>
                <input  type="text" className="login__input" placeholder="Enter your name" {...register("lastName")} />
...
export default RegisterCutomer;
